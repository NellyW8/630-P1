...
dft_delay=dft_delay-41;      %Remove six delay caused by the RRC filter

%Recover the signal
signal_rec=zeros(800,1);
for k=1:800
    signal_rec(k)=exp(-2*pi*f_est*k*1i/16000)*signal_r2(k+40+dft_delay,1);     %some problem about the formulas given by teacher
end
